...
function lexer_idle_default(self, data, c)
    -- item 23
    self.state = "idle"
end
...
function make_lexer()
    ...
    obj.digit = function(self, data, c)
        ...
        if _state_ == "idle" then
            lexer_idle_digit(self, data, c)
        elseif _state_ == "identifier" then
            lexer_identifier_digit(self, data, c)
        elseif _state_ == "number" then
            lexer_number_digit(self, data, c)
        elseif _state_ == "operator" then
            lexer_operator_digit(self, data, c)
        end
    end
    obj.dummy = function(self, data, c)
        local _state_ = self.state
        if _state_ == "idle" then
            lexer_idle_default(self, data, c)
        elseif _state_ == "number" then
            lexer_number_dummy(self, data, c)
        end
    end
    obj.letter = function(self, data, c)
        local _state_ = self.state
        if _state_ == "idle" then
            lexer_idle_letter(self, data, c)
        elseif _state_ == "identifier" then
            lexer_identifier_letter(self, data, c)
        elseif _state_ == "number" then
            lexer_number_letter(self, data, c)
        elseif _state_ == "operator" then
            lexer_operator_letter(self, data, c)
        end
    end
    obj.operator = function(self, data, c)
        local _state_ = self.state
        if _state_ == "idle" then
            lexer_idle_operator(self, data, c)
        elseif _state_ == "identifier" then
            lexer_identifier_operator(self, data, c)
        elseif _state_ == "number" then
            lexer_number_operator(self, data, c)
        elseif _state_ == "operator" then
            lexer_operator_operator(self, data, c)
        end
    end
    obj.whitespace = function(self, data, c)
        ...
        if _state_ == "idle" then
            lexer_idle_default(self, data, c)
        elseif _state_ == "identifier" then
            lexer_identifier_whitespace(self, data, c)
        elseif _state_ == "number" then
            lexer_number_whitespace(self, data, c)
        elseif _state_ == "operator" then
            lexer_operator_whitespace(self, data, c)
        end
    end
    return obj
end
