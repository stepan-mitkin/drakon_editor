...
function Lexer() {
  ...
  this.digit = function(data, c) {
    ...
    if (_state_ == "idle") {
      Lexer_idle_digit(this, data, c)
    }
    else if (_state_ == "identifier") {
      Lexer_identifier_digit(this, data, c)
    }
    else if (_state_ == "number") {
      Lexer_number_digit(this, data, c)
    }
    else if (_state_ == "operator") {
      Lexer_operator_digit(this, data, c)
    }
  }
  this.dummy = function(data, c) {
    var _state_ = this.state
    if (_state_ == "number") {
      Lexer_number_dummy(this, data, c)
    }
  }
  this.letter = function(data, c) {
    var _state_ = this.state
    if (_state_ == "idle") {
      Lexer_idle_letter(this, data, c)
    }
    else if (_state_ == "identifier") {
      Lexer_identifier_letter(this, data, c)
    }
    else if (_state_ == "number") {
      Lexer_number_letter(this, data, c)
    }
    else if (_state_ == "operator") {
      Lexer_operator_letter(this, data, c)
    }
  }
  this.operator = function(data, c) {
    var _state_ = this.state
    if (_state_ == "idle") {
      Lexer_idle_operator(this, data, c)
    }
    else if (_state_ == "identifier") {
      Lexer_identifier_operator(this, data, c)
    }
    else if (_state_ == "number") {
      Lexer_number_operator(this, data, c)
    }
    else if (_state_ == "operator") {
      Lexer_operator_operator(this, data, c)
    }
  }
  this.whitespace = function(data, c) {
    var _state_ = this.state
    if (_state_ == "idle") {
      Lexer_idle_whitespace(this, data, c)
    }
    else if (_state_ == "identifier") {
      Lexer_identifier_whitespace(this, data, c)
    }
    else if (_state_ == "number") {
      Lexer_number_whitespace(this, data, c)
    }
    else if (_state_ == "operator") {
      Lexer_operator_whitespace(this, data, c)
    }
  }
}
