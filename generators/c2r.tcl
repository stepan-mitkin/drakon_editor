...
# C without goto operator and comments.


# Register the gen_c2::generate procedure as the code generator for language "C2".
gen::add_generator "C2R" gen_c2r::generate

namespace eval gen_c2r {
...
proc highlight { tokens } {
	variable c2r_keywords
	return [ gen_cs::highlight_generic $c2r_keywords $tokens ]
}
...
proc make_callbacks { } {
	...
	gen::put_callback callbacks assign			gen_c2r::assign
	gen::put_callback callbacks compare			gen_c2r::compare
	gen::put_callback callbacks compare2		gen_c2r::compare
	gen::put_callback callbacks while_start 	gen_c2r::while_start
	gen::put_callback callbacks if_start		gen_c2r::if_start
	gen::put_callback callbacks elseif_start	gen_c2r::elseif_start
	gen::put_callback callbacks if_end			gen_c2r::if_end
	gen::put_callback callbacks else_start		gen_c2r::else_start
	gen::put_callback callbacks pass			gen_c2r::pass
	gen::put_callback callbacks return_none		gen_c2r::return_none
	gen::put_callback callbacks block_close		gen_c2r::block_close
	gen::put_callback callbacks comment			gen_c2r::comment
	gen::put_callback callbacks bad_case		gen_c2r::bad_case
	gen::put_callback callbacks for_declare		gen_c2r::foreach_declare	
	gen::put_callback callbacks for_init		gen_c2r::foreach_init
	gen::put_callback callbacks for_check		gen_c2r::foreach_check
	gen::put_callback callbacks for_current		gen_c2r::foreach_current
	gen::put_callback callbacks for_incr		gen_c2r::foreach_incr
	gen::put_callback callbacks and				gen_c2r::and
	gen::put_callback callbacks or				gen_c2r::or
	gen::put_callback callbacks not				gen_c2r::not
	gen::put_callback callbacks break			"break;"
	gen::put_callback callbacks declare			gen_c2r::declare
	gen::put_callback callbacks shelf			gen_c2r::shelf
				
	gen::put_callback callbacks body			gen_c2r::generate_body
	gen::put_callback callbacks signature		gen_cpp::extract_signature
	gen::put_callback callbacks native_foreach	gen_c2r::native_foreach
