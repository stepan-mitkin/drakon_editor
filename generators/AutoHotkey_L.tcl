...
proc bad_case { switch_var select_icon_number } {
    #item 1408
    return "Msgbox, Error. Valid condition in Switch macroicon is not met.`nNumber\
    of Select icon: $select_icon_number .`nScript will exit to prevent any unintended behavior.\nExitApp"
}
